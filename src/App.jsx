...
// ---- Design tokens ----
// Color: warm marketplace palette — gold, green, and red accents.
const COLORS = {
  bg: "#FBF8F2",
  ink: "#1A1A1A",
  gold: "#D4A017",
...
export default function Nexora() {
  ...
  const [checkoutStep, setCheckoutStep] = useState(null); // null | "form" | "done"
          ...
          >
            ...
            {checkoutStep === "done" ? (
              ...
              <>
                  ...
                  <div key={item.id} style={{ display: "flex", gap: 10, marginBottom: 14, background: COLORS.card, padding: 10, borderRadius: 8, border: `1px solid ${COLORS.line}` }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 6 }}>
                        ...
                        <button onClick={() => removeItem(item.id)} style={{ marginLeft: "auto", background: "none", border: "none", color: COLORS.red, fontSize: 12 }}>
                          Remove
                        </button>
                      </div>
                    </div>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", fontSize: 15, fontWeight: 700, margin: "16px 0" }}>
                  <span>Subtotal</span>
                  <span style={{ fontFamily: "'JetBrains Mono', monospace" }}>GH₵{cartTotal}</span>
                </div>
                <button
                  onClick={() => setCheckoutStep("form")}
                  style={{ width: "100%", background: COLORS.gold, color: COLORS.ink, border: "none", borderRadius: 8, padding: "13px 0", fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}
                >
